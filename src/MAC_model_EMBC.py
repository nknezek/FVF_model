...
class Model(FVF_model_base.Model):
    '''
    Class to run the FVF model for MAC waves with Electromagnetic boundary conditions
    ...
    def make_A(self):
        ...
        self.thlorentz.add_d2_b0('bth', C= E/Pm, k_vals=range(1,Nk))
        ...
        self.phlorentz.add_d2_b0('bph', C= E/Pm, k_vals=range(1,Nk))
        ...
        self.div.add_dr_b0('vr', k_vals=range(1,Nk))
        self.div.add_dth('vth', k_vals=range(1,Nk))
        self.div.add_dph('vph', k_vals=range(1,Nk))
