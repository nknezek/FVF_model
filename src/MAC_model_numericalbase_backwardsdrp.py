...
class Model(FVF_model_base.Model):
    ...
    def make_A(self):
        ...
        ### use backwards difference for pressure within the non-stratified layer:
        self.rmom.add_drP_bd('p', ones, k_vals=range(1,index_bottom_stratified))
        self.rmom.add_term('p', ones, k_vals=[0])
        ...
        self.add_gov_equation('div', 'vr')
        self.div.add_dr_b0('vr', k_vals=range(index_bottom_stratified,Nk-1))
        self.div.add_dr_bd('vr', k_vals=range(1,index_bottom_stratified))
