...
class Model(FVF_model_base.Model):
    '''
    Class to run the FVF model for MAC waves with Psuedo-vacuum boundary conditions
    ...
    def make_A(self):
        ...
        self.rmom.add_drP('p', C= -1, k_vals=range(Nk))
        self.rmom.add_term('ur', -N**2, k_vals=range(Nk))
        self.rmom.add_d2_b0('vr', C= E, k_vals=range(Nk))
        self.rmom.add_d2r_th('vth', C= E, k_vals=range(Nk))
        self.rmom.add_d2r_ph('vph', C= E, k_vals=range(Nk))
        ...
        self.tmom.add_dthP('p', C= -1, k_vals=range(Nk))
        self.tmom.add_term('vph', 2.0*cos(th), k_vals=range(Nk))
        self.tmom.add_d2_bd0('vth', C= E, k_vals=range(Nk))
        self.tmom.add_d2th_r('vr', C= E, k_vals=range(Nk))
        self.tmom.add_d2th_ph('vph', C= E, k_vals=range(Nk))
        self.tmom.add_dr_b0('bth', C= Br*E/Pm, k_vals=range(Nk))
        ...
        self.pmom.add_dphP('p', C= -1, k_vals=range(Nk))
        self.pmom.add_term('vth', -2.0*cos(th), k_vals=range(Nk))
        self.pmom.add_d2_bd0('vph', C= E, k_vals=range(Nk))
        self.pmom.add_d2ph_r('vr', C= E, k_vals=range(Nk))
        self.pmom.add_d2ph_th('vth', C= E, k_vals=range(Nk))
        self.pmom.add_dr_b0('bph', C= Br*E/Pm, k_vals=range(Nk))
        ...
        self.thlorentz.add_dr_bd0('vth', C= Br, k_vals=range(Nk))
        self.thlorentz.add_d2_b0('bth', C= E/Pm, k_vals=range(Nk))
        self.thlorentz.add_d2th_ph('bph', C= E/Pm, k_vals=range(Nk))
        ...
        self.phlorentz.add_dr_bd0('vph', C= Br, k_vals=range(Nk))
        self.phlorentz.add_d2_b0('bph', C= E/Pm, k_vals=range(Nk))
        self.phlorentz.add_d2ph_th('bth', C= E/Pm, k_vals=range(Nk))
        ...
        self.div.add_dr_b0('vr', k_vals=range(Nk))
        self.div.add_dth('vth', k_vals=range(Nk))
        self.div.add_dph('vph', k_vals=range(Nk))
    ...
    def make_B(self):
        ...
        self.B_vth.add_term('vth', ones, k_vals=range(Nk))
        ...
        self.B_vph.add_term('vph', ones, k_vals=range(Nk))
        ...
        self.B_thlorentz.add_term('bth', ones, k_vals=range(Nk))
        ...
        self.B_phlorentz.add_term('bph', ones, k_vals=range(Nk))
